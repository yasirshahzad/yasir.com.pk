...
export default function FloatingToolbar({
  ...
  return (
    <div className="flex items-center gap-2 px-3 py-2 bg-white/90 dark:bg-gray-900/90 backdrop-blur-xl rounded-2xl shadow-2xl border border-gray-200/50 dark:border-gray-800/50 z-[100]">
      {/* Formatting Group */}
      <div className="flex items-center gap-1 pr-2 border-r border-gray-200 dark:border-gray-700">
        ...
        <div className="w-px h-4 mx-0.5 bg-gray-100 dark:bg-gray-800" />
      ...
      <div className="flex items-center gap-1 pr-2 border-r border-gray-200 dark:border-gray-700">
        ...
        <ToolbarButton onClick={() => onHeading(2)} title="H2">
           <span className="text-[10px] font-bold">H2</span>
        </ToolbarButton>
      </div>
...
function ToolbarButton({ children, onClick, title }: { children: React.ReactNode; onClick: () => void; title: string }) {
  return (
    <button
      ...
      onClick={onClick}
      title={title}
      className="w-8 h-8 flex items-center justify-center rounded-lg text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-gray-900 dark:hover:text-white transition-all transform active:scale-90"
    >
      {children}
    </button>
  )
