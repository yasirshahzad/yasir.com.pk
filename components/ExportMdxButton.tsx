...
export default function ExportMdxButton() {
  ...
  return (
    <button
      ...
      title="Export as MDX"
      className="rounded-full bg-gray-200 p-2 text-gray-500 transition-all hover:bg-gray-300 disabled:opacity-50 dark:bg-gray-700 dark:text-gray-400 dark:hover:bg-gray-600"
    >
      {isExporting ? (
